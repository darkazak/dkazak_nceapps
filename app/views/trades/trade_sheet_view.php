...
//     echo "Items List: ";
//     echo "<br>";
//     print_r($data['trade_sheet_items']);
//     echo "<br>";
//     echo "<br>";
//     echo "Retail Total: ";
//     echo $data['retail_price_total'];
//     echo "<br>";
//     echo "<br>";
//     echo "Trade Total: ";
//     echo $data['trade_price_total'];
//     echo "<br>";
//     echo "<br>";
//     echo "Purchase Total: ";
//     echo $data['purchase_price_total'];
// }
...
$trade_sheet_items_objects_array = $data['trade_sheet_items'];
...
<div class="container">
    <div class="row">
        <div class="col-md-12 ms-0">
            <h2>Trade Sheet</h2>
            <p>trade sheet id: <?php echo $_SESSION['trade_sheet_id'] . ", item count: " . count($trade_sheet_items_objects_array); ?> </p>
            ...
            <div class="row mb-5">
                <div class="col-4">
                    <div class="row">
                        <?php if (varIsNotEmpty($_SESSION['customer_id'])) : ?>
                            ...
                            <div id="customer_data" name="customer_data" class="col d-flex align-self-end">
                                <p class="mb-0">for:<br>
                                    ...
                                    if ($_SESSION['customer_phone'] != '') {
                                        ...
                                        echo '<span class="text-secondary"><i>no phone number</i></span><br>';
                                    }
                                    if ($_SESSION['customer_email'] != '') {
                                        echo $_SESSION['customer_email'] . "<br>";
                                    } else {
                                        echo '<span class="text-secondary"><i>no email</i></span><br>';
                                    }
                            ...
                            <div class="col d-flex align-self-end">
                                <form id="edit_customer_form" action="<?php echo URLROOT . '/customers/edit/' . $_SESSION['customer_id'] ?>" method="post" target="_self">
                                    <input type="submit" class="btn btn-very-small btn-success text-light" value="Edit Customer Data">
                                </form>
                            </div>
                        <?php endif; ?>
                        <div class="col d-flex align-self-end">
                            <form id="edit_customer_form" action="<?php echo URLROOT . '/customers/search'; ?>" method="post" target="_self">
                                <input type="submit" class="btn btn-very-small btn-success text-light" value="Add Customer">
                            </form>
                        </div>
                    </div>
                </div> <!-- col -->
...
<div class="container-fluid">
            ...
            <table class="table table-striped table-sm trade-sheet-table">
                <thead>
                    <tr>
                        ...
                        <th class="border border-bottom-0 align-bottom pb-0" id="trade_line_label_1">Trade</th>
                        <th class="border border-bottom-0 align-bottom pb-0" id="purchase_line_label_1">Purchase</th>
                    ...
                    <tr>
                        ...
                        <th class="border border-top-0" id="trade_line_label_2">Offer</th>
                        <th class="border border-top-0" id="purchase_line_label_2">Offer</th>
                        <th class="border border-top-0 border-end-0"></th>
                        <th class="border border-top-0 border-start-0"></th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($trade_sheet_items_objects_array as $line) : ?>
                        <tr class="table-bordered">
                            <td>
                                <?php echo str_pad((int)$line->trade_item_id, strlen((int)$line->trade_item_id) + 1, "0", STR_PAD_LEFT); ?>
                            </td>
                            <td style="text-align: center;"><?php echo $line->item_title; ?></td>
                ...
                <tfoot class="totals-row border-top border-bottom border-secondary border-2">
                    <tr>
                        ...
                        <th></th>
                        <th></th> -->
                        <th colspan="10" class="totals-entry py-3">
                            <span class="totals-label me-4">Totals</span>
                            <span id="retail_total_set" class="bg-primary bg-opacity-25 px-3 py-2 me-4 rounded-2">
                                <span class="me-1">Retail:</span>
                                <span class="me-1" id="retail_total" name="retail_total">
                                    <?php echo  "$" . number_format($data['retail_price_total'], 2, ".", ","); ?>
                                </span>
                            </span>
                            <span id="trade_total_set" class="bg-warning bg-opacity-25 px-3 py-2 me-4 rounded-2">
                                <span class="me-1">Trade:</span>
                                <span class="me-1" id="trade_total" name="trade_total">
                                    <?php echo  "$" . number_format($data['trade_price_total'], 2, ".", ","); ?>
                                </span>
                            </span>
                            <span id="purchase_total_set" class="bg-success bg-opacity-25 px-3 py-2 me-0 rounded-2">
                                <span class="me-1">Purchase:</span>
                                <span class="me-1" id="purchase_total" name="purchase_total">
                                    <?php echo  "$" . number_format($data['purchase_price_total'], 2, ".", ","); ?>
                                </span>
                            </span>
                        </th>
                        <th colspan="2"></th>
    ...
    <form id="print_data" action="<?php echo URLROOT; ?>/trades/print" method="post" target="_blank">
        ...
        <input type="hidden" id="retail_total_calc" name="retail_total_calc" value="<?php echo $data['retail_price_total']; ?>">
        <input type="hidden" id="trade_total_calc" name="trade_total_calc" value="<?php echo $data['trade_price_total']; ?>">
        <input type="hidden" id="purchase_total_calc" name="purchase_total_calc" value="<?php echo $data['purchase_price_total']; ?>">
...
<div class="container">
    <div class="row">
        <div class="col-md-12 ms-0">
            ...
            <input id="print_for_customer_btn" type="button" class="btn btn-success text-light" value="Print for Customer">
